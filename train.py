...
parser.add_argument("--style_image", default="images/style.jpg", help='path to style image')
parser.add_argument("--content_image", default="images/content.jpg", help='path to style image')
parser.add_argument("--niter", type=int, default=50, help='number of epochs to train for')
parser.add_argument("--lr", type=float, default=1e1, help='learning rate, default=0.001')
...
# split content layers and style layers to a list
